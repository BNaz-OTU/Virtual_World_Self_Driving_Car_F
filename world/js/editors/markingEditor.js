class MarkingEditor {
  ...
  // to be overwritten by the other subclasses
  ...
  #addEventListeners() {
    // Without .bind(), 'this' will refer to the canvas (canvas doesn't have graph
    // the graphEditor has access to the graph), thus not allowing access to the
